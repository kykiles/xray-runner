...
// RestoreSudoOwnerFile hands an open file created under sudo back to the
// invoking user (SUDO_UID/SUDO_GID). Files the tool writes as root land
// root-owned 0600 and stay unreadable to the person who ran it — the log being
// the one they need. Handing ownership over by descriptor resolves nothing on
